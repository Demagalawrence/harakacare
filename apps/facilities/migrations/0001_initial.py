    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.CharField(blank=True, db_index=True, default='', help_text='Administrative district where the facility is located', max_length=100, verbose_name='district')),
            ...
            options={
                ...
                'ordering': ['name'],
                'indexes': [models.Index(fields=['facility_type'], name='facilities__facilit_dd5426_idx'), models.Index(fields=['is_active'], name='facilities__is_acti_a1584a_idx'), models.Index(fields=['latitude', 'longitude'], name='facilities__latitud_c27960_idx')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['facility', 'created_at'], name='facilities__facilit_781c1c_idx'), models.Index(fields=['change_reason'], name='facilities__change__15691c_idx'), models.Index(fields=['source'], name='facilities__source_476b0f_idx')],
            },
        ),
        migrations.AddIndex(
